...
- ✅ "Türklingel" → NFC normalized correctly
- ✅ "Büro Tür" → NFC normalized correctly  
- ✅ "Außentür" → NFC normalized correctly

**Test 4-6: Unicode Form Consistency**
- ✅ NFC composed characters matched correctly
- ✅ NFD decomposed characters normalized to NFC and matched
- ✅ Mixed composition forms handled consistently

**Test 7-9: Edge Case Handling**
- ✅ Empty string ("") handled safely
- ✅ None value handled safely
- ✅ Whitespace-only strings normalized correctly

**Test 10: ASCII Compatibility**
- ✅ Regular ASCII door names ("Front Door", "Back Gate") unaffected

**Syntax Validation:** 
- ✅ `python -m py_compile hub.py` passed without errors

**Total: 10/10 tests passed successfully**  
